package com.saidur.stylesplash.ui.order.trackorder.sales.adapter;
...
public class SalesListAdapter extends RecyclerView.Adapter<SalesListAdapter.CancelorderVH>{
    ...
    public SalesListAdapter(Context context/*, List<CancleData> cancelList*/) {
    ...
    public CancelorderVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.recy_allsaleslitem, parent, false);
    ...
    public class CancelorderVH extends RecyclerView.ViewHolder {
        ...
        public CancelorderVH(@NonNull View v) {
            super(v);
            ocodeTv = v.findViewById(R.id.salenumber);
            custNameTv = v.findViewById(R.id.saleName);
            custNumberTv = v.findViewById(R.id.saleMobile);
            priceTv = v.findViewById(R.id.saleprice);
            dateTv = v.findViewById(R.id.saleDate);
        }
    }
